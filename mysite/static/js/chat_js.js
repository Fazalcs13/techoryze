      ...
      function createRow(text, who) {
          ...
          if(who == "me"){
              ...
              $row = $('<div class="chat-message clearfix">\
                 <img src="http://127.0.0.1:8000/static/images/icon/user_icon.png" alt="" width="32" height="32">\
               ...
               $row = $('<div class="chat-message clearfix">\
                  <img src="http://127.0.0.1:8000/static/images/icon/usermalecircle.png" alt="" width="32" height="32">\
                  <div class="chat-message-content clearfix">\
                  <h5>John Powers</h5>\
                  <p id="text1">'+text+'</p>\
                  </div>\
