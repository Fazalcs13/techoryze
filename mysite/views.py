...
def courses_view(request, course_name):
    if request.user.is_authenticated():
        ...
        if course_name == u'Microsoft_Office_Suite':
            ...
            coursesTopic = CoursesTopic.objects.get(course_title = 'Microsoft Office Suite')
            ...
            coursesTopic = CoursesTopic.objects.get(course_title='Graphic Design')
            context = {'courses': courses, 'courseTopic': coursesTopic}
            return render(request, template, context)
            ...
            coursesTopic = CoursesTopic.objects.get(course_title='Web Site Development')
            context = {'courses': courses, 'courseTopic': coursesTopic}
            return render(request, template, context)
